...
The published image is `ghcr.io/p-hoffmann/trexsql:latest`. The easiest way to run a full stack (Trex + Postgres + Realtime, with a built-in PostgREST-compatible REST API) is via the provided compose file:
