(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,774234,554855,e=>{"use strict";var a=e.i(348534);e.s(["CollapsibleContent_Shadcn_",()=>a.CollapsibleContent],774234),e.s(["CollapsibleTrigger_Shadcn_",()=>a.CollapsibleTrigger],554855)},925282,e=>{"use strict";var a=e.i(348534);e.s(["Collapsible_Shadcn_",()=>a.Collapsible])},833655,e=>{"use strict";var a=e.i(532480);e.s(["Info",()=>a.default])},331720,e=>{"use strict";var a=e.i(478902),t=e.i(837710);e.s(["FormActions",0,({form:e,hasChanges:n,handleReset:r,helper:l,disabled:s=!1,isSubmitting:o,submitText:i="Save"})=>{let c=o||s||!n&&void 0!==n;return(0,a.jsxs)("div",{className:["flex w-full items-center gap-2",l?"justify-between":"justify-end"].join(" "),children:[l&&(0,a.jsx)("span",{className:"text-sm text-foreground-lighter",children:l}),(0,a.jsxs)("div",{className:"flex items-center gap-2",children:[(0,a.jsx)(t.Button,{disabled:c,type:"default",htmlType:"reset",onClick:()=>r(),children:"Cancel"}),(0,a.jsx)(t.Button,{form:e,type:"primary",htmlType:"submit",disabled:c,loading:o,children:i})]})]})}])},768441,757489,e=>{"use strict";e.i(850036);var a=e.i(479084);function t({search:e,ignoredSchemas:n=[]}={}){let r=(0,a.joinSqlFragments)(n.map(e=>(0,a.literal)(e)),", ");return a.safeSql`
    table_privileges as (
      select
        c.oid::int as id,
  ...
  `},"getExposedFunctionsSql",0,function({search:e,offset:t,limit:r,ignoredSchemas:l=[]}){return a.safeSql`
  ...
  `},"getExposedTableCountsSql",0,function({selectedSchemas:e,ignoredSchemas:n=[]}){let r=e.length>0?(0,a.joinSqlFragments)(e.map(e=>(0,a.literal)(e)),", "):a.safeSql`''`;return a.safeSql`
    ...
    select
      ...
      (count(*) filter (where status = 'granted' and schema_name in (${r})))::int as grants_count
    from table_grants
  `},"getExposedTablesSql",0,function({search:e,offset:n,limit:r,ignoredSchemas:l=[]}){return a.safeSql`
  ...
  `}],757489);var l=e.i(180141),s=e.i(818135),o=e.i(714403);async function i({projectRef:e,connectionString:a,schema:t},n){if(!e)throw Error("projectRef is required");let l=r({schema:t}),{result:s}=await (0,o.executeSql)({projectRef:e,connectionString:a,sql:l,queryKey:["default-privileges-state"]},n);return 3===s[0].grant_count}e.s(["defaultPrivilegesQueryOptions",0,({projectRef:e,connectionString:a,schema:t},{enabled:n=!0}={})=>(0,l.queryOptions)({queryKey:s.privilegeKeys.defaultPrivileges(e,t),queryFn:({signal:n})=>i({projectRef:e,connectionString:a,schema:t},n),enabled:n&&void 0!==e})],768441)},996870,e=>{"use strict";var a=e.i(704598);e.s(["CircleAlert",()=>a.default])},549487,e=>{"use strict";var a=e.i(38429),t=e.i(356003),n=e.i(355901),r=e.i(78162),l=e.i(234745),s=e.i(915993);async function o({projectRef:e,dbSchema:a,maxRows:t,dbExtraSearchPath:n,dbPool:r}){let s={db_schema:a,max_rows:t,db_extra_search_path:n};r&&(s.db_pool=r);let{data:i,error:c}=await (0,l.patch)("/platform/projects/{ref}/config/postgrest",{params:{path:{ref:e}},body:s});return c&&(0,l.handleError)(c),i}e.s(["useProjectPostgrestConfigUpdateMutation",0,({onSuccess:e,onError:l,...i}={})=>{let c=(0,t.useQueryClient)();return(0,a.useMutation)({mutationFn:e=>o(e),async onSuccess(a,t,n){let{projectRef:l}=t;await Promise.all([c.invalidateQueries({queryKey:r.configKeys.postgrest(l)}),c.invalidateQueries({queryKey:s.lintKeys.lint(l)})]),await e?.(a,t,n)},async onError(e,a,t){void 0===l?n.toast.error(`Failed to update Postgrest config: ${e.message}`):l(e,a,t)},...i})}])},247413,e=>{"use strict";var a=e.i(462142);e.s(["useIsDataApiEnabled",0,({projectRef:e})=>{let{data:t,...n}=(0,a.useProjectPostgrestConfigQuery)({projectRef:e}),r=!!t?.db_schema?.trim();return{...n,data:r,isEnabled:r}}])},111887,e=>{"use strict";var a=e.i(478902);e.i(128328);var t=e.i(158639),n=e.i(867637),r=e.i(178527),l=e.i(206413),s=e.i(592360),o=e.i(937942);e.s(["DataApiDisabledState",0,({description:e})=>{let{ref:i}=(0,t.useParams)();return(0,a.jsx)("div",{className:"flex w-full flex-1 items-center justify-center p-10",children:(0,a.jsxs)(r.Alert_Shadcn_,{className:"max-w-md",children:[(0,a.jsx)(n.AlertCircle,{size:16}),(0,a.jsx)(s.AlertTitle_Shadcn_,{children:"Data API is disabled"}),(0,a.jsxs)(l.AlertDescription_Shadcn_,{children:["Enable the Data API in the"," ",(0,a.jsx)(o.InlineLink,{href:`/project/${i}/integrations/data_api/overview`,children:"Overview"})," ","tab to ",e,"."]})]})})}])}]);