(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,620893,e=>{"use strict";var o=e.i(478902),n=e.i(331162);let t={nodejs:{installCommands:["npm install postgres"],files:[{name:"db.js",content:`import postgres from 'postgres'
...
try:
    ...
    print(f"Failed to connect: {e}")`}]}};e.s(["default",0,function({state:e}){let s=t[e.connectionType??"uri"],r=s?.installCommands??[];return 0===r.length?null:(0,o.jsx)("div",{className:"flex flex-col gap-2",children:r.map(e=>(0,o.jsx)(n.CodeBlock,{className:"[&_code]:text-foreground",wrapperClassName:"lg:col-span-2",value:e,hideLineNumbers:!0,language:"bash",children:e},`example-install-command-${e}`))})}],620893)}]);