...
Read more: https://nextjs.org/docs/messages/next-image-missing-loader`),"__NEXT_ERROR_CODE",{value:"E252",enumerable:!1,configurable:!0})}]]);function x(e){return void 0!==e.default}function v({config:e,src:t,unoptimized:i,layout:n,width:a,quality:r,sizes:s,loader:o}){if(i){if(t.startsWith("/")&&!t.startsWith("//")){let e=(0,_.getDeploymentId)();if(e){let i=t.indexOf("?");if(-1!==i){let n=new URLSearchParams(t.slice(i+1));n.get("dpl")||(n.append("dpl",e),t=t.slice(0,i)+"?"+n.toString())}else t+=`?dpl=${e}`}}return{src:t,srcSet:void 0,sizes:void 0}}let{widths:l,kind:d}=function({deviceSizes:e,allSizes:t},i,n,a){if(a&&("fill"===n||"responsive"===n)){let i=/(^|\s)(1?\d?\d)vw/g,n=[];for(let e;e=i.exec(a);)n.push(parseInt(e[2]));if(n.length){let i=.01*Math.min(...n);return{widths:t.filter(t=>t>=e[0]*i),kind:"w"}}return{widths:t,kind:"w"}}return"number"!=typeof i||"fill"===n||"responsive"===n?{widths:e,kind:"w"}:{widths:[...new Set([i,2*i].map(e=>t.find(t=>t>=e)||t[t.length-1]))],kind:"x"}}(e,a,n,s),c=l.length-1;return{sizes:s||"w"!==d?s:"100vw",srcSet:l.map((i,n)=>`${o({config:e,src:t,quality:r,width:i})} ${"w"===d?i:n+1}${d}`).join(", "),src:o({config:e,src:t,quality:r,width:l[c]})}}function E(e){return"number"==typeof e?e:"string"==typeof e?parseInt(e,10):void 0}function k(e){let t=e.config?.loader||"default",i=j.get(t);if(i)return i(e);throw Object.defineProperty(Error(`Unknown "loader" found in "next.config.js". Expected: ${d.VALID_LOADERS.join(", ")}. Received: ${t}`),"__NEXT_ERROR_CODE",{value:"E1026",enumerable:!1,configurable:!0})}function A(e,t,i,n,a,r){e&&e.src!==w&&e["data-loaded-src"]!==t&&(e["data-loaded-src"]=t,("decode"in e?e.decode():Promise.resolve()).catch(()=>{}).then(()=>{if(e.parentNode&&(h.add(t),"blur"===n&&r(!0),a?.current)){let{naturalWidth:t,naturalHeight:i}=e;a.current({naturalWidth:t,naturalHeight:i})}}))}let R=({imgAttributes:e,heightInt:t,widthInt:i,qualityInt:n,layout:a,className:o,imgStyle:l,blurStyle:d,isLazy:c,placeholder:u,loading:p,srcString:m,config:b,unoptimized:_,loader:g,onLoadingCompleteRef:f,setBlurComplete:y,setIntersection:h,onLoad:w,onError:j,isVisible:x,noscriptSizes:E,...k})=>(p=c?"lazy":p,(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("img",{...k,...e,decoding:"async","data-nimg":a,className:o,style:{...l,...d},ref:(0,s.useCallback)(e=>{h(e),e?.complete&&A(e,m,a,u,f,y)},[h,m,a,u,f,y]),onLoad:e=>{A(e.currentTarget,m,a,u,f,y),w&&w(e)},onError:e=>{"blur"===u&&y(!0),j&&j(e)}}),(c||"blur"===u)&&(0,r.jsx)("noscript",{children:(0,r.jsx)("img",{...k,loading:p,decoding:"async","data-nimg":a,style:l,className:o,...v({config:b,src:m,unoptimized:_,layout:a,width:i,quality:n,sizes:E,loader:g})})})]}));function S({src:e,sizes:t,unoptimized:i=!1,priority:n=!1,loading:a,lazyRoot:o=null,lazyBoundary:m,className:b,quality:_,width:g,height:j,style:A,objectFit:T,objectPosition:$,onLoadingComplete:N,placeholder:O="empty",blurDataURL:q,...I}){var P;let z,D=(0,s.useContext)(u.ImageConfigContext),L=(0,s.useMemo)(()=>{let e=y||D||d.imageConfigDefault,t=[...e.deviceSizes,...e.imageSizes].sort((e,t)=>e-t),i=e.deviceSizes.sort((e,t)=>e-t),n=e.qualities?.sort((e,t)=>e-t);return{...e,allSizes:t,deviceSizes:i,qualities:n,localPatterns:"u"<typeof window?D?.localPatterns:e.localPatterns}},[D]),C=t?"responsive":"intrinsic";"layout"in I&&(I.layout&&(C=I.layout),delete I.layout);let F=k;if("loader"in I){if(I.loader){let e=I.loader;F=t=>{let{config:i,...n}=t;return e(n)}}delete I.loader}let U="";if("object"==typeof(P=e)&&(x(P)||void 0!==P.src)){let t=x(e)?e.default:e;if(!t.src)throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include src. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E460",enumerable:!1,configurable:!0});if(q=q||t.blurDataURL,U=t.src,(!C||"fill"!==C)&&(j=j||t.height,g=g||t.width,!t.height||!t.width))throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include height and width. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E48",enumerable:!1,configurable:!0})}e="string"==typeof e?e:U,(0,p.warnOnce)(`Image with src "${e}" is using next/legacy/image which is deprecated and will be removed in a future version of Next.js.`);let M=!n&&("lazy"===a||void 0===a);(e.startsWith("data:")||e.startsWith("blob:"))&&(i=!0,M=!1),"u">typeof window&&h.has(e)&&(M=!1),L.unoptimized&&(i=!0);let[K,W]=(0,s.useState)(!1),[Q,B,G]=(0,c.useIntersection)({rootRef:o,rootMargin:m||"200px",disabled:!M}),H=!M||B,X={boxSizing:"border-box",display:"block",overflow:"hidden",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},Y={boxSizing:"border-box",display:"block",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},J=!1,V=E(g),Z=E(j),ee=E(_),et=Object.assign({},A,{position:"absolute",top:0,left:0,bottom:0,right:0,boxSizing:"border-box",padding:0,border:"none",margin:"auto",display:"block",width:0,height:0,minWidth:"100%",maxWidth:"100%",minHeight:"100%",maxHeight:"100%",objectFit:T,objectPosition:$}),ei="blur"!==O||K?{}:{backgroundSize:T||"cover",backgroundPosition:$||"0% 0%",filter:"blur(20px)",backgroundImage:`url("${q}")`};if("fill"===C)X.display="block",X.position="absolute",X.top=0,X.left=0,X.bottom=0,X.right=0;else if(void 0!==V&&void 0!==Z){let e=Z/V,t=isNaN(e)?"100%":`${100*e}%`;"responsive"===C?(X.display="block",X.position="relative",J=!0,Y.paddingTop=t):"intrinsic"===C?(X.display="inline-block",X.position="relative",X.maxWidth="100%",J=!0,Y.maxWidth="100%",z=`data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27${V}%27%20height=%27${Z}%27/%3e`):"fixed"===C&&(X.display="inline-block",X.position="relative",X.width=V,X.height=Z)}let en={src:w,srcSet:void 0,sizes:void 0};H&&(en=v({config:L,src:e,unoptimized:i,layout:C,width:V,quality:ee,sizes:t,loader:F}));let ea=e,er=f?void 0:{imageSrcSet:en.srcSet,imageSizes:en.sizes,crossOrigin:I.crossOrigin,referrerPolicy:I.referrerPolicy},es="u"<typeof window?s.default.useEffect:s.default.useLayoutEffect,eo=(0,s.useRef)(N),el=(0,s.useRef)(e);(0,s.useEffect)(()=>{eo.current=N},[N]),es(()=>{el.current!==e&&(G(),el.current=e)},[G,e]);let ed={isLazy:M,imgAttributes:en,heightInt:Z,widthInt:V,qualityInt:ee,layout:C,className:b,imgStyle:et,blurStyle:ei,loading:a,config:L,unoptimized:i,placeholder:O,loader:F,srcString:ea,onLoadingCompleteRef:eo,setBlurComplete:W,setIntersection:Q,isVisible:H,noscriptSizes:t,...I};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("span",{style:X,children:[J?(0,r.jsx)("span",{style:Y,children:z?(0,r.jsx)("img",{style:{display:"block",maxWidth:"100%",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},alt:"","aria-hidden":!0,src:z}):null}):null,(0,r.jsx)(R,{...ed})]}),!f&&n?(0,r.jsx)(l.default,{children:(0,r.jsx)("link",{rel:"preload",as:"image",href:en.srcSet?void 0:en.src,...er},"__nimg-"+en.src+en.srcSet+en.sizes)}):null]})}("function"==typeof i.default||"object"==typeof i.default&&null!==i.default)&&void 0===i.default.__esModule&&(Object.defineProperty(i.default,"__esModule",{value:!0}),Object.assign(i.default,i),t.exports=i.default)},501964,(e,t,i)=>{t.exports=e.r(498943)},418029,e=>{"use strict";var t=e.i(478902),i=e.i(837710),n=e.i(843778);e.s(["NoSearchResults",0,({searchString:e,withinTableCell:a=!1,onResetFilter:r,className:s,label:o,description:l})=>(0,t.jsxs)("div",{className:(0,n.cn)("flex items-center justify-between",!a&&"bg-surface-100 px-4 md:px-6 py-4 rounded-md border border-default",s),children:[(0,t.jsxs)("div",{className:"text-sm flex flex-col gap-y-0.5",children:[(0,t.jsx)("p",{className:"text-foreground",children:o??"No results found"}),(0,t.jsx)("p",{className:"text-foreground-lighter",children:l??`Your search for “${e}” did not return any results`})]}),void 0!==r&&(0,t.jsx)(i.Button,{type:"default",onClick:()=>r(),children:"Reset filter"})]})])},938343,e=>{"use strict";e.s(["tableEditorKeys",0,{tableEditor:(e,t)=>["projects",e,"table-editor",t].filter(Boolean)}])},34479,664304,e=>{"use strict";e.i(850036);var t=e.i(479084);let i=({id:e})=>e?`
