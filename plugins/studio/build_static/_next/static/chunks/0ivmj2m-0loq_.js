...
Read more: https://nextjs.org/docs/messages/next-image-missing-loader`),"__NEXT_ERROR_CODE",{value:"E252",enumerable:!1,configurable:!0})}]]);function j(e){return void 0!==e.default}function v({config:e,src:t,unoptimized:i,layout:n,width:a,quality:r,sizes:s,loader:o}){if(i){if(t.startsWith("/")&&!t.startsWith("//")){let e=(0,f.getDeploymentId)();if(e){let i=t.indexOf("?");if(-1!==i){let n=new URLSearchParams(t.slice(i+1));n.get("dpl")||(n.append("dpl",e),t=t.slice(0,i)+"?"+n.toString())}else t+=`?dpl=${e}`}}return{src:t,srcSet:void 0,sizes:void 0}}let{widths:l,kind:d}=function({deviceSizes:e,allSizes:t},i,n,a){if(a&&("fill"===n||"responsive"===n)){let i=/(^|\s)(1?\d?\d)vw/g,n=[];for(let e;e=i.exec(a);)n.push(parseInt(e[2]));if(n.length){let i=.01*Math.min(...n);return{widths:t.filter(t=>t>=e[0]*i),kind:"w"}}return{widths:t,kind:"w"}}return"number"!=typeof i||"fill"===n||"responsive"===n?{widths:e,kind:"w"}:{widths:[...new Set([i,2*i].map(e=>t.find(t=>t>=e)||t[t.length-1]))],kind:"x"}}(e,a,n,s),c=l.length-1;return{sizes:s||"w"!==d?s:"100vw",srcSet:l.map((i,n)=>`${o({config:e,src:t,quality:r,width:i})} ${"w"===d?i:n+1}${d}`).join(", "),src:o({config:e,src:t,quality:r,width:l[c]})}}function k(e){return"number"==typeof e?e:"string"==typeof e?parseInt(e,10):void 0}function E(e){let t=e.config?.loader||"default",i=x.get(t);if(i)return i(e);throw Object.defineProperty(Error(`Unknown "loader" found in "next.config.js". Expected: ${d.VALID_LOADERS.join(", ")}. Received: ${t}`),"__NEXT_ERROR_CODE",{value:"E1026",enumerable:!1,configurable:!0})}function A(e,t,i,n,a,r){e&&e.src!==w&&e["data-loaded-src"]!==t&&(e["data-loaded-src"]=t,("decode"in e?e.decode():Promise.resolve()).catch(()=>{}).then(()=>{if(e.parentNode&&(y.add(t),"blur"===n&&r(!0),a?.current)){let{naturalWidth:t,naturalHeight:i}=e;a.current({naturalWidth:t,naturalHeight:i})}}))}let R=({imgAttributes:e,heightInt:t,widthInt:i,qualityInt:n,layout:a,className:o,imgStyle:l,blurStyle:d,isLazy:c,placeholder:u,loading:p,srcString:m,config:b,unoptimized:f,loader:g,onLoadingCompleteRef:_,setBlurComplete:h,setIntersection:y,onLoad:w,onError:x,isVisible:j,noscriptSizes:k,...E})=>(p=c?"lazy":p,(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("img",{...E,...e,decoding:"async","data-nimg":a,className:o,style:{...l,...d},ref:(0,s.useCallback)(e=>{y(e),e?.complete&&A(e,m,a,u,_,h)},[y,m,a,u,_,h]),onLoad:e=>{A(e.currentTarget,m,a,u,_,h),w&&w(e)},onError:e=>{"blur"===u&&h(!0),x&&x(e)}}),(c||"blur"===u)&&(0,r.jsx)("noscript",{children:(0,r.jsx)("img",{...E,loading:p,decoding:"async","data-nimg":a,style:l,className:o,...v({config:b,src:m,unoptimized:f,layout:a,width:i,quality:n,sizes:k,loader:g})})})]}));function S({src:e,sizes:t,unoptimized:i=!1,priority:n=!1,loading:a,lazyRoot:o=null,lazyBoundary:m,className:b,quality:f,width:g,height:x,style:A,objectFit:C,objectPosition:N,onLoadingComplete:T,placeholder:$="empty",blurDataURL:D,...O}){var I;let P,q=(0,s.useContext)(u.ImageConfigContext),z=(0,s.useMemo)(()=>{let e=h||q||d.imageConfigDefault,t=[...e.deviceSizes,...e.imageSizes].sort((e,t)=>e-t),i=e.deviceSizes.sort((e,t)=>e-t),n=e.qualities?.sort((e,t)=>e-t);return{...e,allSizes:t,deviceSizes:i,qualities:n,localPatterns:"u"<typeof window?q?.localPatterns:e.localPatterns}},[q]),L=t?"responsive":"intrinsic";"layout"in O&&(O.layout&&(L=O.layout),delete O.layout);let F=E;if("loader"in O){if(O.loader){let e=O.loader;F=t=>{let{config:i,...n}=t;return e(n)}}delete O.loader}let M="";if("object"==typeof(I=e)&&(j(I)||void 0!==I.src)){let t=j(e)?e.default:e;if(!t.src)throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include src. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E460",enumerable:!1,configurable:!0});if(D=D||t.blurDataURL,M=t.src,(!L||"fill"!==L)&&(x=x||t.height,g=g||t.width,!t.height||!t.width))throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include height and width. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E48",enumerable:!1,configurable:!0})}e="string"==typeof e?e:M,(0,p.warnOnce)(`Image with src "${e}" is using next/legacy/image which is deprecated and will be removed in a future version of Next.js.`);let U=!n&&("lazy"===a||void 0===a);(e.startsWith("data:")||e.startsWith("blob:"))&&(i=!0,U=!1),"u">typeof window&&y.has(e)&&(U=!1),z.unoptimized&&(i=!0);let[K,W]=(0,s.useState)(!1),[Q,B,H]=(0,c.useIntersection)({rootRef:o,rootMargin:m||"200px",disabled:!U}),G=!U||B,X={boxSizing:"border-box",display:"block",overflow:"hidden",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},Y={boxSizing:"border-box",display:"block",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},J=!1,V=k(g),Z=k(x),ee=k(f),et=Object.assign({},A,{position:"absolute",top:0,left:0,bottom:0,right:0,boxSizing:"border-box",padding:0,border:"none",margin:"auto",display:"block",width:0,height:0,minWidth:"100%",maxWidth:"100%",minHeight:"100%",maxHeight:"100%",objectFit:C,objectPosition:N}),ei="blur"!==$||K?{}:{backgroundSize:C||"cover",backgroundPosition:N||"0% 0%",filter:"blur(20px)",backgroundImage:`url("${D}")`};if("fill"===L)X.display="block",X.position="absolute",X.top=0,X.left=0,X.bottom=0,X.right=0;else if(void 0!==V&&void 0!==Z){let e=Z/V,t=isNaN(e)?"100%":`${100*e}%`;"responsive"===L?(X.display="block",X.position="relative",J=!0,Y.paddingTop=t):"intrinsic"===L?(X.display="inline-block",X.position="relative",X.maxWidth="100%",J=!0,Y.maxWidth="100%",P=`data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27${V}%27%20height=%27${Z}%27/%3e`):"fixed"===L&&(X.display="inline-block",X.position="relative",X.width=V,X.height=Z)}let en={src:w,srcSet:void 0,sizes:void 0};G&&(en=v({config:z,src:e,unoptimized:i,layout:L,width:V,quality:ee,sizes:t,loader:F}));let ea=e,er=_?void 0:{imageSrcSet:en.srcSet,imageSizes:en.sizes,crossOrigin:O.crossOrigin,referrerPolicy:O.referrerPolicy},es="u"<typeof window?s.default.useEffect:s.default.useLayoutEffect,eo=(0,s.useRef)(T),el=(0,s.useRef)(e);(0,s.useEffect)(()=>{eo.current=T},[T]),es(()=>{el.current!==e&&(H(),el.current=e)},[H,e]);let ed={isLazy:U,imgAttributes:en,heightInt:Z,widthInt:V,qualityInt:ee,layout:L,className:b,imgStyle:et,blurStyle:ei,loading:a,config:z,unoptimized:i,placeholder:$,loader:F,srcString:ea,onLoadingCompleteRef:eo,setBlurComplete:W,setIntersection:Q,isVisible:G,noscriptSizes:t,...O};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("span",{style:X,children:[J?(0,r.jsx)("span",{style:Y,children:P?(0,r.jsx)("img",{style:{display:"block",maxWidth:"100%",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},alt:"","aria-hidden":!0,src:P}):null}):null,(0,r.jsx)(R,{...ed})]}),!_&&n?(0,r.jsx)(l.default,{children:(0,r.jsx)("link",{rel:"preload",as:"image",href:en.srcSet?void 0:en.src,...er},"__nimg-"+en.src+en.srcSet+en.sizes)}):null]})}("function"==typeof i.default||"object"==typeof i.default&&null!==i.default)&&void 0===i.default.__esModule&&(Object.defineProperty(i.default,"__esModule",{value:!0}),Object.assign(i.default,i),t.exports=i.default)},501964,(e,t,i)=>{t.exports=e.r(498943)},418029,e=>{"use strict";var t=e.i(478902),i=e.i(837710),n=e.i(843778);e.s(["NoSearchResults",0,({searchString:e,withinTableCell:a=!1,onResetFilter:r,className:s,label:o,description:l})=>(0,t.jsxs)("div",{className:(0,n.cn)("flex items-center justify-between",!a&&"bg-surface-100 px-4 md:px-6 py-4 rounded-md border border-default",s),children:[(0,t.jsxs)("div",{className:"text-sm flex flex-col gap-y-0.5",children:[(0,t.jsx)("p",{className:"text-foreground",children:o??"No results found"}),(0,t.jsx)("p",{className:"text-foreground-lighter",children:l??`Your search for “${e}” did not return any results`})]}),void 0!==r&&(0,t.jsx)(i.Button,{type:"default",onClick:()=>r(),children:"Reset filter"})]})])},938343,e=>{"use strict";e.s(["tableEditorKeys",0,{tableEditor:(e,t)=>["projects",e,"table-editor",t].filter(Boolean)}])},34479,664304,e=>{"use strict";e.i(850036);var t=e.i(479084);let i=({id:e})=>e?`
