...
Read more: https://nextjs.org/docs/messages/next-image-missing-loader`),"__NEXT_ERROR_CODE",{value:"E252",enumerable:!1,configurable:!0})}]]);function j(e){return void 0!==e.default}function v({config:e,src:t,unoptimized:i,layout:n,width:a,quality:r,sizes:s,loader:o}){if(i){if(t.startsWith("/")&&!t.startsWith("//")){let e=(0,f.getDeploymentId)();if(e){let i=t.indexOf("?");if(-1!==i){let n=new URLSearchParams(t.slice(i+1));n.get("dpl")||(n.append("dpl",e),t=t.slice(0,i)+"?"+n.toString())}else t+=`?dpl=${e}`}}return{src:t,srcSet:void 0,sizes:void 0}}let{widths:l,kind:d}=function({deviceSizes:e,allSizes:t},i,n,a){if(a&&("fill"===n||"responsive"===n)){let i=/(^|\s)(1?\d?\d)vw/g,n=[];for(let e;e=i.exec(a);)n.push(parseInt(e[2]));if(n.length){let i=.01*Math.min(...n);return{widths:t.filter(t=>t>=e[0]*i),kind:"w"}}return{widths:t,kind:"w"}}return"number"!=typeof i||"fill"===n||"responsive"===n?{widths:e,kind:"w"}:{widths:[...new Set([i,2*i].map(e=>t.find(t=>t>=e)||t[t.length-1]))],kind:"x"}}(e,a,n,s),c=l.length-1;return{sizes:s||"w"!==d?s:"100vw",srcSet:l.map((i,n)=>`${o({config:e,src:t,quality:r,width:i})} ${"w"===d?i:n+1}${d}`).join(", "),src:o({config:e,src:t,quality:r,width:l[c]})}}function k(e){return"number"==typeof e?e:"string"==typeof e?parseInt(e,10):void 0}function E(e){let t=e.config?.loader||"default",i=w.get(t);if(i)return i(e);throw Object.defineProperty(Error(`Unknown "loader" found in "next.config.js". Expected: ${d.VALID_LOADERS.join(", ")}. Received: ${t}`),"__NEXT_ERROR_CODE",{value:"E1026",enumerable:!1,configurable:!0})}function R(e,t,i,n,a,r){e&&e.src!==x&&e["data-loaded-src"]!==t&&(e["data-loaded-src"]=t,("decode"in e?e.decode():Promise.resolve()).catch(()=>{}).then(()=>{if(e.parentNode&&(y.add(t),"blur"===n&&r(!0),a?.current)){let{naturalWidth:t,naturalHeight:i}=e;a.current({naturalWidth:t,naturalHeight:i})}}))}let A=({imgAttributes:e,heightInt:t,widthInt:i,qualityInt:n,layout:a,className:o,imgStyle:l,blurStyle:d,isLazy:c,placeholder:u,loading:p,srcString:m,config:b,unoptimized:f,loader:g,onLoadingCompleteRef:h,setBlurComplete:_,setIntersection:y,onLoad:x,onError:w,isVisible:j,noscriptSizes:k,...E})=>(p=c?"lazy":p,(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("img",{...E,...e,decoding:"async","data-nimg":a,className:o,style:{...l,...d},ref:(0,s.useCallback)(e=>{y(e),e?.complete&&R(e,m,a,u,h,_)},[y,m,a,u,h,_]),onLoad:e=>{R(e.currentTarget,m,a,u,h,_),x&&x(e)},onError:e=>{"blur"===u&&_(!0),w&&w(e)}}),(c||"blur"===u)&&(0,r.jsx)("noscript",{children:(0,r.jsx)("img",{...E,loading:p,decoding:"async","data-nimg":a,style:l,className:o,...v({config:b,src:m,unoptimized:f,layout:a,width:i,quality:n,sizes:k,loader:g})})})]}));function S({src:e,sizes:t,unoptimized:i=!1,priority:n=!1,loading:a,lazyRoot:o=null,lazyBoundary:m,className:b,quality:f,width:g,height:w,style:R,objectFit:N,objectPosition:C,onLoadingComplete:$,placeholder:T="empty",blurDataURL:I,...O}){var P;let z,q=(0,s.useContext)(u.ImageConfigContext),D=(0,s.useMemo)(()=>{let e=_||q||d.imageConfigDefault,t=[...e.deviceSizes,...e.imageSizes].sort((e,t)=>e-t),i=e.deviceSizes.sort((e,t)=>e-t),n=e.qualities?.sort((e,t)=>e-t);return{...e,allSizes:t,deviceSizes:i,qualities:n,localPatterns:"u"<typeof window?q?.localPatterns:e.localPatterns}},[q]),F=t?"responsive":"intrinsic";"layout"in O&&(O.layout&&(F=O.layout),delete O.layout);let L=E;if("loader"in O){if(O.loader){let e=O.loader;L=t=>{let{config:i,...n}=t;return e(n)}}delete O.loader}let M="";if("object"==typeof(P=e)&&(j(P)||void 0!==P.src)){let t=j(e)?e.default:e;if(!t.src)throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include src. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E460",enumerable:!1,configurable:!0});if(I=I||t.blurDataURL,M=t.src,(!F||"fill"!==F)&&(w=w||t.height,g=g||t.width,!t.height||!t.width))throw Object.defineProperty(Error(`An object should only be passed to the image component src parameter if it comes from a static image import. It must include height and width. Received ${JSON.stringify(t)}`),"__NEXT_ERROR_CODE",{value:"E48",enumerable:!1,configurable:!0})}e="string"==typeof e?e:M,(0,p.warnOnce)(`Image with src "${e}" is using next/legacy/image which is deprecated and will be removed in a future version of Next.js.`);let U=!n&&("lazy"===a||void 0===a);(e.startsWith("data:")||e.startsWith("blob:"))&&(i=!0,U=!1),"u">typeof window&&y.has(e)&&(U=!1),D.unoptimized&&(i=!0);let[K,W]=(0,s.useState)(!1),[B,Q,H]=(0,c.useIntersection)({rootRef:o,rootMargin:m||"200px",disabled:!U}),G=!U||Q,X={boxSizing:"border-box",display:"block",overflow:"hidden",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},V={boxSizing:"border-box",display:"block",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},Y=!1,J=k(g),Z=k(w),ee=k(f),et=Object.assign({},R,{position:"absolute",top:0,left:0,bottom:0,right:0,boxSizing:"border-box",padding:0,border:"none",margin:"auto",display:"block",width:0,height:0,minWidth:"100%",maxWidth:"100%",minHeight:"100%",maxHeight:"100%",objectFit:N,objectPosition:C}),ei="blur"!==T||K?{}:{backgroundSize:N||"cover",backgroundPosition:C||"0% 0%",filter:"blur(20px)",backgroundImage:`url("${I}")`};if("fill"===F)X.display="block",X.position="absolute",X.top=0,X.left=0,X.bottom=0,X.right=0;else if(void 0!==J&&void 0!==Z){let e=Z/J,t=isNaN(e)?"100%":`${100*e}%`;"responsive"===F?(X.display="block",X.position="relative",Y=!0,V.paddingTop=t):"intrinsic"===F?(X.display="inline-block",X.position="relative",X.maxWidth="100%",Y=!0,V.maxWidth="100%",z=`data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27${J}%27%20height=%27${Z}%27/%3e`):"fixed"===F&&(X.display="inline-block",X.position="relative",X.width=J,X.height=Z)}let en={src:x,srcSet:void 0,sizes:void 0};G&&(en=v({config:D,src:e,unoptimized:i,layout:F,width:J,quality:ee,sizes:t,loader:L}));let ea=e,er=h?void 0:{imageSrcSet:en.srcSet,imageSizes:en.sizes,crossOrigin:O.crossOrigin,referrerPolicy:O.referrerPolicy},es="u"<typeof window?s.default.useEffect:s.default.useLayoutEffect,eo=(0,s.useRef)($),el=(0,s.useRef)(e);(0,s.useEffect)(()=>{eo.current=$},[$]),es(()=>{el.current!==e&&(H(),el.current=e)},[H,e]);let ed={isLazy:U,imgAttributes:en,heightInt:Z,widthInt:J,qualityInt:ee,layout:F,className:b,imgStyle:et,blurStyle:ei,loading:a,config:D,unoptimized:i,placeholder:T,loader:L,srcString:ea,onLoadingCompleteRef:eo,setBlurComplete:W,setIntersection:B,isVisible:G,noscriptSizes:t,...O};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("span",{style:X,children:[Y?(0,r.jsx)("span",{style:V,children:z?(0,r.jsx)("img",{style:{display:"block",maxWidth:"100%",width:"initial",height:"initial",background:"none",opacity:1,border:0,margin:0,padding:0},alt:"","aria-hidden":!0,src:z}):null}):null,(0,r.jsx)(A,{...ed})]}),!h&&n?(0,r.jsx)(l.default,{children:(0,r.jsx)("link",{rel:"preload",as:"image",href:en.srcSet?void 0:en.src,...er},"__nimg-"+en.src+en.srcSet+en.sizes)}):null]})}("function"==typeof i.default||"object"==typeof i.default&&null!==i.default)&&void 0===i.default.__esModule&&(Object.defineProperty(i.default,"__esModule",{value:!0}),Object.assign(i.default,i),t.exports=i.default)},501964,(e,t,i)=>{t.exports=e.r(498943)},418029,e=>{"use strict";var t=e.i(478902),i=e.i(837710),n=e.i(843778);e.s(["NoSearchResults",0,({searchString:e,withinTableCell:a=!1,onResetFilter:r,className:s,label:o,description:l})=>(0,t.jsxs)("div",{className:(0,n.cn)("flex items-center justify-between",!a&&"bg-surface-100 px-4 md:px-6 py-4 rounded-md border border-default",s),children:[(0,t.jsxs)("div",{className:"text-sm flex flex-col gap-y-0.5",children:[(0,t.jsx)("p",{className:"text-foreground",children:o??"No results found"}),(0,t.jsx)("p",{className:"text-foreground-lighter",children:l??`Your search for “${e}” did not return any results`})]}),void 0!==r&&(0,t.jsx)(i.Button,{type:"default",onClick:()=>r(),children:"Reset filter"})]})])},568213,e=>{"use strict";var t=e.i(478902),i=e.i(88816),n=e.i(544197),a=e.i(211570),r=e.i(389959),s=e.i(655744),o=e.i(837710),l=e.i(843778),d=e.i(874311),c=e.i(20482),u=e.i(378277);e.s(["KeyValueFieldArray",0,({control:e,name:p,keyFieldName:m,valueFieldName:b,createEmptyRow:f,keyPlaceholder:g,valuePlaceholder:h,addLabel:_,addActions:y=[],disabled:x=!1,inputSize:w="small",className:j,rowsClassName:v="space-y-3 mt-1",rowClassName:k,keyInputClassName:E,valueInputClassName:R,addButtonClassName:A,removeButtonClassName:S,removeLabel:N="Remove row"})=>{let{fields:C,append:$,remove:T}=(0,s.useFieldArray)({control:e,name:p,keyName:"fieldId"}),I=y.length>0,O=`${_} options`;return(0,t.jsxs)("div",{className:(0,l.cn)("space-y-3",j),children:[(0,t.jsx)("div",{className:v,children:C.map((i,n)=>(0,t.jsxs)("div",{className:(0,l.cn)("flex items-start space-x-2",k),children:[(0,t.jsx)(c.FormField,{control:e,name:`${p}.${n}.${m}`,render:({field:e})=>(0,t.jsxs)(c.FormItem,{className:"flex-1",children:[(0,t.jsx)(c.FormControl,{children:(0,t.jsx)(u.Input_Shadcn_,{...e,size:w,className:(0,l.cn)("w-full",E),placeholder:g,disabled:x})}),(0,t.jsx)(c.FormMessage,{})]})}),(0,t.jsx)(c.FormField,{control:e,name:`${p}.${n}.${b}`,render:({field:e})=>(0,t.jsxs)(c.FormItem,{className:"flex-1",children:[(0,t.jsx)(c.FormControl,{children:(0,t.jsx)(u.Input_Shadcn_,{...e,size:w,className:(0,l.cn)("w-full",R),placeholder:h,disabled:x})}),(0,t.jsx)(c.FormMessage,{})]})}),(0,t.jsx)(o.Button,{type:"default",size:"tiny",htmlType:"button",icon:(0,t.jsx)(a.Trash,{size:12}),"aria-label":N,disabled:x,onClick:()=>T(n),className:(0,l.cn)("h-[34px] w-[34px] shrink-0",S)})]},i.fieldId))}),(0,t.jsxs)("div",{className:"flex items-center",children:[(0,t.jsx)(o.Button,{type:"default",size:"tiny",htmlType:"button",icon:(0,t.jsx)(n.Plus,{}),disabled:x,onClick:()=>$(f()),className:(0,l.cn)(I&&"rounded-r-none border-r-0 px-3",A),children:_}),I&&(0,t.jsxs)(d.DropdownMenu,{children:[(0,t.jsx)(d.DropdownMenuTrigger,{asChild:!0,children:(0,t.jsx)(o.Button,{type:"default",size:"tiny",htmlType:"button",icon:(0,t.jsx)(i.ChevronDown,{size:14}),"aria-label":O,disabled:x,className:"rounded-l-none px-[4px] py-[5px]"})}),(0,t.jsx)(d.DropdownMenuContent,{align:"end",side:"bottom",children:y.map(e=>(0,t.jsxs)(r.Fragment,{children:[e.separatorAbove&&(0,t.jsx)(d.DropdownMenuSeparator,{}),(0,t.jsx)(d.DropdownMenuItem,{onClick:()=>{var t;$(Array.isArray(t=e.createRows())&&1===t.length?t[0]:t)},children:e.description?(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsx)("div",{className:"block text-foreground",children:e.label}),(0,t.jsx)("div",{className:"text-foreground-light",children:e.description})]}):e.label})]},e.key))})]})]})]})}])},916800,478029,e=>{"use strict";let t=e=>"string"==typeof e?e.trim():"";e.s(["getKeyValueFieldArrayValidationIssues",0,({rows:e,keyFieldName:i,valueFieldName:n,keyRequiredMessage:a,valueRequiredMessage:r,duplicateKeyMessage:s,allowEmptyRows:o=!0,normaliseKey:l=e=>e})=>{let d=[],c=s?new Map:null;return e.forEach((e,s)=>{let u=t(e[i]),p=t(e[n]);if(!u&&!p){o||(d.push({path:[s,i],message:a}),d.push({path:[s,n],message:r}));return}if(!u)return void d.push({path:[s,i],message:a});if(!p)return void d.push({path:[s,n],message:r});if(!c)return;let m=l(u);m&&c.set(m,[...c.get(m)??[],s])}),c&&s&&c.forEach(e=>{e.length<2||e.forEach(e=>{d.push({path:[e,i],message:s})})}),d},"stripEmptyKeyValueFieldArrayRows",0,({rows:e,keyFieldName:i,valueFieldName:n})=>e.filter(e=>{let a=t(e[i]),r=t(e[n]);return a.length>0||r.length>0})],916800);var i=e.i(97429);let n=/^https?:\/\//,a="(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]?\\d)",r=RegExp(`^(?:${a}\\.){3}${a}$`),s=/^\[[0-9a-f:.]+\]$/i;e.s(["httpEndpointUrlSchema",0,({requiredMessage:e,invalidMessage:t,prefixMessage:a})=>i.z.string().trim().min(1,e).superRefine((e,o)=>{if(e){if(!n.test(e))return void o.addIssue({code:i.z.ZodIssueCode.custom,message:a});(e=>{try{let t=new URL(e);if("http:"!==t.protocol&&"https:"!==t.protocol)return!1;let{hostname:i}=t;return"localhost"===i||i.includes(".")||r.test(i)||s.test(i)}catch{return!1}})(e)||o.addIssue({code:i.z.ZodIssueCode.custom,message:t})}})],478029)},938343,e=>{"use strict";e.s(["tableEditorKeys",0,{tableEditor:(e,t)=>["projects",e,"table-editor",t].filter(Boolean)}])},34479,664304,e=>{"use strict";e.i(850036);var t=e.i(479084);let i=({id:e})=>e?`
